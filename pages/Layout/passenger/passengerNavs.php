          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <h3 style="font-size: 28px;color: #ff8000">Passeneger</h3>
                <ul class="nav side-menu">
                  <li class="<?php echo $passengerHome;?>"><a  href="/huvmts/Accounts/passenger"><i class="fa fa-home"></i> Home </a></li>
                  <li class="<?php echo $schedule;?>"><a  href="/huvmts/Accounts/passenger/schedule"><i class="fa fa-home"></i> View schedule </a></li>
                   <li class="<?php echo $schedule;?>"><a  href="/huvmts/Accounts/passenger/Update"><i class="fa fa-user"></i> Update me </a></li>
                  <li class="<?php echo $Tracking;?>"><a href="/huvmts/Accounts/passenger/Tracking"><i class="fa icon-location"></i>Tracking</a></li>

                   <li>
                    <a><i class="fa icon-envelop"></i>Message<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/huvmts/Accounts/passenger/Message/index.php">inbox</a></li>
                      <li><a href="/huvmts/Accounts/passenger/message/outbox.php">write message</a></li>
                      <li><a href="/huvmts/Accounts/passenger/message/sented.php">outbox</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="/huvmts/accounts/passenger/profile.php"> Profile</a></li>
                    <li>
                      <a href="/huvmts/Accounts/passenger/edit profile.php">
                        <span>Settings</span>
                      </a>
                    </li>
