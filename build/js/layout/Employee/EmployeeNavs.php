            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li class="<?php echo $EmployeeHome;?>"><a  href="/huvmts/Accounts/Employee"><i class="fa fa-home"></i> Home </a></li>
                  <li class="<?php echo $EmployeeNotification;?>"><a  href="/huvmts/Accounts/Employee/Notification"><i class="fa fa-home"></i> Notification </a></li>
                  <li class="<?php echo $EmployeeFeedback;?>"><a href="/huvmts/Accounts/Employee/Feedback"><i class="fa icon-message"></i>Feedback</a></li>
                </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="/huvmts/accounts/Employee/profile.php"> Profile</a></li>
                    <li>
                      <a href="/huvmts/Accounts/Employee/edit profile.php">
                        <span>Settings</span>
                      </a>
                    </li>
