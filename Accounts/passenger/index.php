                      ...
                      <div class="col-md-offset-1 col-md-10">
                        <div class=" bs-callout bs-callout-warning" id="callout-glyphicons-accessibility">
                          <div  style="text-align: justify;font-size: 20px; color: black;" class="column column-double column-content single"> 
                           <h1 style="color:  #100c4a; font-size: 35px;">Well Come To Haramaya University Transportation Passenger or HU employees Dashboard!</h1>       
                            ...
                            <div>
                              <h3>Role of passenger</h3>
                              <ul>
                                <li>Track the real location of vehicle.</li>
                                <li>update his/her information</li>
                                <li>view schedule to know which vehicle they are going to use within whom is driver </li>
                                <li>Send and recieve message as a feedback or for smooth communication</li>
                              </ul>
                            </div></p>
