              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <img width="100%" src="help/home.jpg">
                      </div>
                      <div class="col-md-8">
                        <h3>Home</h3>
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <img width="100%" src="help/Prepare Message.jpg">
                      </div>
                      <div class="col-md-8">
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <img width="100%" src="help/Out box messages.jpg">
                      </div>
                      <div class="col-md-8">
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <img width="100%" src="help/send request.jpg">
                      </div>
                      <div class="col-md-8">
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <img width="100%" src="help/List of rquest.jpg">
                      </div>
                      <div class="col-md-8">
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <img width="100%" src="help/Reports.jpg">
                      </div>
                      <div class="col-md-8">
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <img width="100%" src="help/notification.jpg">
                      </div>
                      <div class="col-md-8">
