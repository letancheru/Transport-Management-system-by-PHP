                      ...
                      <div class="col-md-offset-1 col-md-10">
                        <div class=" bs-callout bs-callout-warning" id="callout-glyphicons-accessibility">
                          <div  style="text-align: justify;font-size: 20px; color: black;" class="column column-double column-content single"> 
                            <h1 style="color:  #100c4a; font-size: 35px;">Well Come To Haramaya University Transportation Driver Dashboard!</h1>       
                            ...
                            <div>
                              ...
                              <ul>
                                <li>view schedule to know when and whre they have to go</li>
                                <li>send coordinates by using android application installed on their phone</li>
                                <li>send and recieve messages as a feedback and for other smooth communication</li>
                                <li>send reports for manager</li>
                              </ul>
                            </div></p>
                            <img class="col-md-12 col-sm-12 col-xs-12" style="max-width: 920px;height: 500px;" src="../../asset/176.jpg">
