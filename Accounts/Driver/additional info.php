...
$title = "additional info";
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `driver`(`driver_id`, `firstname`, `lastname`, `report`, `username`) 
    VALUES ('$driver_id','$firstname ','$lastname','not','$username');";
          ...
          <div class="">
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i> Additional Info <small>Please enter you Idetification number please</small></h2>
                          ...
                          <div class="row">
                              <form name="addir" id="addir" class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Idetification number<span class="is required">*</span>
                                  </label>
...
<script type="text/javascript">
  function deptnameF () {
    ...
    if (firstname_field=="is required" || firstname_field=="should be numeric") {
  ...
  function deptnameB () {
    ...
    if(x==""||x==null){
      ...
      document.getElementById("deptname").style.color="brown";
      document.getElementById("deptname").style.fontWeight="bold";
      document.getElementById("deptname").value="should be numeric value";
    };
  }
