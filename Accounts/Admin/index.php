                ...
                <div class="x_panel">
                      <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        <?php                  
                          ...
                          $raw_results = mysql_query("SELECT * FROM `post` WHERE `acct_type` LIKE 'Admin' ORDER BY Time DESC") or die(mysql_error());
                      ...
                      <div class="col-md-offset-1 col-md-10">
                        <div class=" bs-callout bs-callout-warning" id="callout-glyphicons-accessibility">
                          <div  style="text-align: justify;font-size: 20px; color: black;" class="column column-double column-content single"> 
                            <h1 style="color:  #100c4a; font-size: 35px;">Well Come To Haramaya University Transportation Admin Dashboard!</h1>       
                            ...
                            <div>
                              <h3>Role of Admin</h3>
                              <ul>
                                <li>Register user such as driver, passenger, destributive employee manager, security and department.</li>
                                <li>update user info</li>
                                <li>send and recieve message as a feedbak or for smooth communication</li>
                                <li>post news for all users</li>
                              </ul>
                            </div></p>
                       <img class="col-md-12 col-sm-12 col-xs-12" style="max-width: 920px;height: 500px;" src="../../asset/leta12.jpg">
