...
?>
        <!-- page content -->
          ...
          <div style="color: black; font-size: 19px;" class="">
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div style="color: black; font-size: 19px;" class="x_title">
                    <h2 style="color: black; font-size: 19px;"><i class="fa fa-bars"></i> Vehicle Managment adding new vehicle, removing vehicle face problem, update some information about the vehicles</h2>
