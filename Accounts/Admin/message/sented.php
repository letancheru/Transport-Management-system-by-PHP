        ...
        <!-- page content -->
          <div class="">
            <?php
              ...
              $raw_results = mysql_query("SELECT * FROM `message` WHERE `sender` = '".$_SESSION['username']."' ORDER BY Time DESC") or die(mysql_error());
            ?>
                      ...
                      <div class="col-sm-3 mail_list_column">
                        <?php  
                          while($results = mysql_fetch_array($raw_results)){
                            ...
                            while ($reciver = mysql_fetch_array($sqlSender)) {
                        ?>
                        <a href="sented.php?<?php $meID = $results['m_id']; echo $meID;?>">
                          <div class="mail_list">
                            <div class="left">
                              <i class="fa fa-circle"></i> <i class="fa fa-edit"></i>
                            </div>
                            <div class="right">
                              <h3><?php echo $reciver['firstname'].' '.$reciver['lastname'];?>
                                <small>
                                  <?php  
                                    $now = new DateTime;
                      ...
                      <div class="col-sm-9 mail_view">                        
                        <div class="inbox-body">
                          ...
                          if (isset($username)) {
                            if (isset($_SERVER['QUERY_STRING']) && $_SERVER['QUERY_STRING']!="") {
                              ...
                              while($results = mysql_fetch_array($raw_results)){
                                ...
                                $SqlReciver = mysql_query("SELECT `firstname`,`lastname`,`acct_type` FROM account where `username`='".$results['reciver']."';");
                                while ($reciver = mysql_fetch_array($SqlReciver)) {
                          ...
                          <div class="sender-info">
                            <div class="row">
                              ...
                              <div class="col-md-12">
                                ...
                                <strong><?php echo $recivername;?></strong>
                          ...
                          <div class="mail_heading row">
                            ...
                            <div class="col-md-12">
                              <h4>you dont sent any message yet</h4>
                            </div>
                          </div>
                          <?php
                          }
