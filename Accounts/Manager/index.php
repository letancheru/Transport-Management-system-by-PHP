                      ...
                      <div class="col-md-offset-1 col-md-10">
                        <div class=" bs-callout bs-callout-warning" id="callout-glyphicons-accessibility">
                          <div  style="text-align: justify;font-size: 20px; color: black;" class="column column-double column-content single"> 
                             <h1 style="color:  #100c4a; font-size: 35px;">Well Come To Haramaya University Transportation Distributer Employee Manager(DEM) Dashboard!</h1>       
                            ...
                            <div>
                              <h3>Role of Manager</h3>
                              <ul>
                                <li>Track the real location of vehicle.</li>
                                <li>update his/her information</li>
                                <li>replay department request as it is needed</li>
                                <li>Prepare request and update schedule as it is needed.</li>
                              </ul>
                            </div></p>
                            <img class="col-md-12 col-sm-12 col-xs-12" style="max-width: 920px;height: 500px;" src="../../asset/car2.jpg">
