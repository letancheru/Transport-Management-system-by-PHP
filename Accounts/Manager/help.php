                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-8">
                        <h3>here manager can send, recieve message from any employee</h3>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-8">
                        <h3>The alert will be shown to the manager</h3>
                        <p>manager can track the real time of vehicle </p>
                      </div>
                    </div>
